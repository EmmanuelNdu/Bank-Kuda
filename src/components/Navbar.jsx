...
// import NaijaLogo from '../constants'
...
const Navbar = () => {
  ...
  return (
    <nav className='sticky top-0 z-50 py-3 shadow-bar_shadow bg-white p-16'>
        <div className='container px-4 mx-auto relative text-sm text-[#40196d]'>
            <div className='flex justify-between items-center text-base '>
                <div className='flex items-center flex-shrink-0'>
                    ...
                    <ul className='hidden lg:flex ml-36 space-x-12 font-semibold gap-8 '>
                ...
                flex flex-col justify-center items-left lg:hidden'>
                    ...
                    <ul>
                        {navItems_m.map((item, index) => (
                            <li key={index} className=' border-b border-gray-300 py-2 font-medium'>
                                <a href={item.href}>{ item.label}</a>
                            </li>
                        ))}
                    </ul>
